...
### RNF-OO4: Confiabilidade

**Descrição:** Validação de Entrada de Dados obrigatoria 
...
| ----------------- | --------- |
| RN-001            | Quantidade de podutos não pode ser megativa |
...
| RN-005            | Toda movimentação deve ser resgistrada |
...
sequenceDiagram
    ...
    Controller ->> Model: atualiação estoque
    Model ->> Controller: retorno
    Controller ->> View: atualizar interface 
...
| - | - | - | - |
| 1.0.0 | 2026-04-14 | Ana Luiza Dore | Versão Inicial |
